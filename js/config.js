...
window.SITE_CONFIG = {
  ...
  // ---------------------------------------------------------------------
  contact: {
    phoneDisplay: "(555) 782-4900",
    phoneRaw: "+15557824900", // used for tel: links
    whatsappNumber: "15557824900", // digits only, used for wa.me links
    whatsappDefaultMessage: "Hello, I'd like to get a quote for your cleaning services.",
    email: "hello@pristineandco.example",
    address: {
      line1: "128 Harbor Mill Road, Suite 4",
      city: "Riverton",
      region: "NY",
      postalCode: "12180",
      full: "128 Harbor Mill Road, Suite 4, Riverton, NY 12180",
    },
    hours: [
  ...
  announcement: {
    enabled: true,
    text: "Now accepting new residential & commercial cleaning clients in the Riverton area.",
  ...
  // ---------------------------------------------------------------------
  serviceAreas: [
    "Riverton", "Millbrook Heights", "Ashford", "Cedar Falls",
    "North Haven", "Oakdale", "Westbridge", "Thornton",
  ],
  serviceAreaCity: "Riverton",
  ...
  services: [
    {
      ...
      detail: "Routine cleaning that keeps every room consistently fresh, dusted, and organized, on a schedule that suits your household.",
    ...
    },
    {
      ...
      detail: "A thorough pass through baseboards, grout, appliances, and every overlooked corner, ideal before a big event or after a long stretch without professional cleaning.",
      image: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=1200&q=80",
      includes: ["Inside appliances", "Baseboards & grout", "Light fixtures & vents", "Cabinet fronts & interiors"],
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1581578017093-cd30fce4eeb7?auto=format&fit=crop&w=1200&q=80",
  ...
  // ---------------------------------------------------------------------
  testimonials: [
    { name: "Hannah Ortiz", location: "Riverton, NY", rating: 5, text: "The team is unbelievably thorough. I've used two other cleaning companies before and neither came close to this level of detail, especially in the kitchen and bathrooms." },
    { name: "Marcus Chen", location: "Cedar Falls, NY", rating: 5, text: "We switched our small office to Pristine & Co. six months ago and it's been completely dependable. Same two cleaners each time, always on schedule." },
    { name: "Priya Anand", location: "Ashford, NY", rating: 5, text: "Booked a move-out clean and got our full deposit back. The landlord actually commented on how spotless the oven and baseboards were." },
    { name: "Daniel Fischer", location: "North Haven, NY", rating: 4, text: "Consistently good biweekly service. One visit ran a little later than expected but they called ahead and made it right on the next clean." },
    { name: "Lauren Ibarra", location: "Westbridge, NY", rating: 5, text: "I manage two Airbnb units and turnover cleaning has to be fast and flawless. This team has never let a turnaround slip." },
    { name: "Ben Okafor", location: "Riverton, NY", rating: 5, text: "Post-renovation cleanup after our kitchen remodel was overwhelming until they came in. Every surface was dust-free within a few hours." },
  ],
  ...
  portfolio: [
    {
      ...
      location: "Riverton, NY",
      description: "A full deep clean addressing built-up grease on the range hood, grout lines, and cabinet fronts.",
      before: "https://images.unsplash.com/photo-1556909212-d5b604d0c90d?auto=format&fit=crop&w=1200&q=60&sat=-60&con=-5",
      after: "https://images.unsplash.com/photo-1556909212-d5b604d0c90d?auto=format&fit=crop&w=1200&q=80",
    },
    {
      ...
      category: "deep",
      categoryLabel: "Deep Cleaning",
      location: "Cedar Falls, NY",
      description: "Grout restoration, descaled fixtures, and a full tile-to-ceiling detail pass.",
      before: "https://images.unsplash.com/photo-1584622781564-1d987f7333c1?auto=format&fit=crop&w=1200&q=60&sat=-60&con=-5",
      after: "https://images.unsplash.com/photo-1584622781564-1d987f7333c1?auto=format&fit=crop&w=1200&q=80",
    },
    {
      ...
      before: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=1200&q=60&sat=-60&con=-5",
    ...
    },
    {
      ...
      location: "Westbridge, NY",
      description: "Weekly commercial contract covering workstations, common areas, and restrooms.",
      before: "https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=1200&q=60&sat=-60&con=-5",
      after: "https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=1200&q=80",
    },
    {
      id: "move-out-clean",
      ...
      before: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=60&sat=-60&con=-5",
    ...
    },
    {
      ...
      before: "https://images.unsplash.com/photo-1581578017093-cd30fce4eeb7?auto=format&fit=crop&w=1200&q=60&sat=-60&con=-5",
      after: "https://images.unsplash.com/photo-1581578017093-cd30fce4eeb7?auto=format&fit=crop&w=1200&q=80",
    },
  ],
  ...
  pricing: {
    ...
    propertySizes: {
      house: [
        { id: "studio", label: "Studio / Small", base: 90 },
        { id: "1-2bed", label: "1–2 Bedrooms", base: 120 },
        { id: "3-4bed", label: "3–4 Bedrooms", base: 170 },
        { id: "5plus", label: "5+ Bedrooms", base: 230 },
      ],
      apartment: [
        { id: "studio", label: "Studio / Small", base: 80 },
        { id: "1-2bed", label: "1–2 Bedrooms", base: 110 },
        { id: "3-4bed", label: "3–4 Bedrooms", base: 155 },
        { id: "5plus", label: "5+ Bedrooms", base: 210 },
      ],
      office: [
        { id: "small", label: "Small Office", base: 100 },
        { id: "medium", label: "Medium Office", base: 180 },
        { id: "large", label: "Large Office", base: 280 },
        { id: "custom", label: "Custom / Multi-Floor", base: 350 },
      ],
      commercial: [
        { id: "small", label: "Small Space", base: 120 },
        { id: "medium", label: "Medium Space", base: 210 },
        { id: "large", label: "Large Space", base: 320 },
        { id: "custom", label: "Custom / Multi-Unit", base: 400 },
      ],
      airbnb: [
        { id: "studio", label: "Studio / Small", base: 70 },
        { id: "1-2bed", label: "1–2 Bedrooms", base: 95 },
        { id: "3-4bed", label: "3–4 Bedrooms", base: 130 },
        { id: "5plus", label: "5+ Bedrooms", base: 175 },
      ],
    },
  ...
  // ---------------------------------------------------------------------
  faqs: [
    { q: "Do I need to provide cleaning supplies?", a: "No. Our team brings all cleaning products and equipment. If you'd prefer we use products you already have on hand, just let us know when booking." },
    ...
    { q: "Do you offer recurring cleaning?", a: "Yes. Weekly, biweekly, and monthly plans are all available, and recurring clients receive a small discount versus one-time visits." },
    ...
    { q: "What areas do you serve?", a: "We serve Riverton and the surrounding areas, including Millbrook Heights, Ashford, Cedar Falls, North Haven, Oakdale, Westbridge, and Thornton." },
    ...
    { q: "What is included in a deep clean?", a: "Deep cleans go beyond routine tidying to cover baseboards, grout, appliance interiors, light fixtures, and other frequently overlooked areas." },
  ],
